...
public class WclockCommand extends AbstractCommand {
	
	public WclockCommand() {
		super("wclock");
	}
	...
	public void process(String arguments, UserSession userSession) {
		...
		if (g instanceof ExaminedGame) {
			...
			gg.setWhiteClock(((hours*60*60) + (minutes*60) + (seconds)) * 1000 * positive);
			...
			final String line = "Game " + gg.getGameNumber() + ": " + userSession.getUser().getUserName() + " sets white's clock to " + b.toString() + ".";
