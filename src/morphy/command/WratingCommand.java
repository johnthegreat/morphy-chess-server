...
public class WratingCommand extends AbstractCommand {
	
	public WratingCommand() {
		super("wrating");
	}
	...
	public void process(String arguments, UserSession userSession) {
		...
		final String line = "Game " + gg.getGameNumber() + ": " + userSession.getUser().getUserName() + " sets white's rating to " + rating + ".";
